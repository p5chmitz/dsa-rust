...
mod toc {
    ...
    fn new() -> GenTree<Heading> {
        let data = crate::trees::unsafe_linked_general_tree::toc::Heading::new_root(0);
    ...
    fn basic_function_test() {
        unsafe {
            use crate::trees::unsafe_linked_general_tree::toc::Heading;
...
pub fn example() {
    use crate::trees::unsafe_linked_general_tree::toc;
